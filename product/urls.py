...
urlpatterns = [
    ...
    path('stocktransferinstancelistpopup/<int:id>/<str:voucher_type>/<int:v_no>/', views.stock_transfer_instance_list_and_recieve, name="stock-transfer-instance-list-popup"),
