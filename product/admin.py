...
from . models import AccountGroup, AccountSubGroup, Finished_goods_Stock_TransferMaster, Picklist_voucher_master,   Product, finished_goods_warehouse_racks, finished_product_warehouse_bin ,  gst,MainCategory ,Color , ProductImage,PProduct_Creation, StockItem, item_godown_quantity_through_table,Finished_goods_transfer_records,Item_Creation, item_purchase_voucher_master, labour_work_in_master, labour_work_in_product_to_item, labour_workin_approval_report, outward_product_master, outward_products, product_2_item_through_table, product_purchase_voucher_items, product_purchase_voucher_master, product_to_item_labour_workout, purchase_order, purchase_order_for_puchase_voucher_rm, purchase_order_for_raw_material, purchase_order_for_raw_material_cutting_items, purchase_order_master_for_puchase_voucher_rm, purchase_order_raw_material_cutting, purchase_order_to_product, purchase_order_to_product_cutting, purchase_voucher_items, raw_material_product_ref_items, raw_material_product_to_items, raw_material_product_wise_qty, raw_material_production_estimation,finishedgoodsbinallocation, raw_material_production_total, temp_product_bin_for_picklist
...
admin.site.register(temp_product_bin_for_picklist)
