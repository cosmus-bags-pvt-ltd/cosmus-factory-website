...
from . models import AccountGroup, AccountSubGroup, Finished_goods_Stock_TransferMaster,   Product ,  gst,MainCategory ,Color , ProductImage,PProduct_Creation, StockItem, item_godown_quantity_through_table,Finished_goods_transfer_records,Item_Creation, item_purchase_voucher_master, product_2_item_through_table, product_purchase_voucher_items, product_purchase_voucher_master, purchase_order, purchase_order_for_puchase_voucher_rm, purchase_order_for_raw_material, purchase_order_for_raw_material_cutting_items, purchase_order_master_for_puchase_voucher_rm, purchase_order_raw_material_cutting, purchase_order_to_product_cutting, purchase_voucher_items, raw_material_product_ref_items, raw_material_production_estimation,finishedgoodsbinallocation, raw_material_production_total
...
# admin.site.register(Finished_goods_Stock_TransferMaster)
admin.site.register(raw_material_production_total)
